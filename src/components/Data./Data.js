...
import './index.scss';
import logo from "../../img/Ellipse 20.png"
                    ...
                    <div className='detail--project'>
                        ...
                        <div className='detail--npm'>
                            <div className='detail--input'>
                                ...
                                <h4>Email</h4>
                                <input style={{height: '39px' , width:'350px'}} name='email' type="email" />
                                <div>
                                    <h4>Пол</h4>
                                    <div className='detail--car'>
                                        <div style={{marginRight : '25px'}} className='detail--Floor'>
                                            <div style={{
                                                display: 'flex',
                                                alignItems: 'center',
                            ...
                            <div className='detail--current'>
                                ...
                                <select className='detail--counter'>
                                    <option value="CA">Кыргызстан</option>
